...
from .views import (
    ...
    VerificationReportEntryCreateView,
    VerificationReportEntryImageDeleteView,
    UserListView,
...
urlpatterns = [
    ...
    path('verification-report/', VerificationReportSiteView.as_view(), name='verification_report_site'),
    path('verification-report/<int:pk>/', VerificationReportDetailView.as_view(), name='verification_report_detail'),
    path('verification-report/<int:pk>/create/', VerificationReportEntryCreateView.as_view(), name='verification_report_entry_create'),
    path('verification-report/images/<int:pk>/delete/', VerificationReportEntryImageDeleteView.as_view(), name='verification_report_image_delete'),
