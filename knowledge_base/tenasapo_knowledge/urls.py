...
urlpatterns = [
    ...
    path('tips/import/csv/', TipsCSVImportView.as_view(), name='tip_csv_import'),
    ...
    path('knowledge/import/csv/', KnowledgeArticleCSVImportView.as_view(), name='article_csv_import'),
